...
<div class="mobile-menu-button-wrapper md:hidden mx-auto pl-24 fixed top-0 flex flex-col justify-center items-center z-50 pt-4 w-screen backdrop-blur-2xl">
	<button class="outline-none mobile-menu-button transition duration-1000 ease-out text-2xl text-schoberDarkRed">
		<!-- <img src="<?php echo $logoUrl[0]; ?>" class="w-12 h-12 mb-2"> -->
		fs
	</button>
	<hr class="menu-divider h-0.5 block w-24 bg-schoberDarkRed border-0 mb-0 pb-0 transition duration-500 ease-out">
</div>


<div class="mobile-menu md:pt-8 hidden md:block md:col-span-1 xl:col-span-2  transition duration-1000 ease-out  bg-schoberDarkRed text-white h-screen w-screen  text-center md:w-36 lg:w-auto lg:relative fixed left-0 top-0 z-40">
